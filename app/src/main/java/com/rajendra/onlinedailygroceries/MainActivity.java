...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView imageSettings,imageShop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       recentlyViewedList.add(new RecentlyViewed("Papaya", "Papayas are spherical or pear-shaped fruits that can be as long as 20 inches.", "৳115", "1", "KG", card3, b3));
       recentlyViewedList.add(new RecentlyViewed("Strawberry", "The strawberry is a highly nutritious fruit, loaded with vitamin C.", "৳650", "250", "G", card2, b1));
       recentlyViewedList.add(new RecentlyViewed("Coconut", "Full of nutrients like vitamin C, vitamin K, vitamin E, folate, and potassium.", "৳140", "1", "PC", card1, b2));
